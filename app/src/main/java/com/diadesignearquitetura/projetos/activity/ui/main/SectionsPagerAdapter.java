package com.diadesignearquitetura.projetos.activity.ui.main;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        if (position == 0) {
            return ProjetoDetalheFragment.newInstance(position + 1);
        }else {
            return ProjetoLevantamentoFragment.newInstance(position + 1);
        }
    }
